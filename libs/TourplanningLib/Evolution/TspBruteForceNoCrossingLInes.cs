...
namespace Logicx.Optimization.Tourplanning.NearestNeighbour
{
    ...
    /// </summary>
    public class TspBruteForceNoCrossingLines
    {
        public TspBruteForceNoCrossingLines(TspStateSpace statespace)
        {
        ...
        public State SolutionState
        {
            ...
            get
            {
                ...
                _solution_state = (TspState)_statespace.InitialState;
                return _solution_state;
            }
        }


        public TspStateSpace StateSpace
        {
            ...
            do
            {
                ...
                if (curr_state.DepthState >= _statespace.CountActions)
                {
                    if (curr_state.CurrentTargetValue < min_cost)
                    {
                        ...
                        _solution_state = (TspState)curr_state;
        ...
        protected TspStateSpace _statespace;
        protected TspState _solution_state;
